...
const FoodSearch = ({ mealType: initialMealType = "breakfast", onClose, date }: FoodSearchProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 px-4 pb-3 overflow-x-auto scrollbar-hide">
        {MEAL_TYPES.map((type) => (
          <button
            ...
            style={{
              background: mealType === type ? "#FF5A16" : "#232220",
              color: mealType === type ? "#fff" : "#9ca3af",
            }}
          >
      ...
      {/* ── Results ── */}
      <div className="flex-1 overflow-y-auto px-4 space-y-3 pb-10">
        {/* Loading */}
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            <Loader2 size={32} color="#FF5A16" className="animate-spin" />
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  style={{
                    background: isAdded ? "#2F2F2F" : "#FF5A16",
